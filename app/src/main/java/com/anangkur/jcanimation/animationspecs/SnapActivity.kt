            ...
            Scaffold(
                ...
                content = {
                    Column(modifier = Modifier.padding(20.dp).verticalScroll(rememberScrollState())) {
                        ...
                        Text(text = getString(R.string.text_expanded_fab_with_snap), fontSize = 14.sp, fontWeight = FontWeight.Bold)
                        ExpandableFabSnap(modifier = Modifier.padding(top = 10.dp))
                        Divider(modifier = Modifier.fillMaxWidth().padding(vertical = 20.dp))
                    }
                }
            )
